...
class AdminColors extends ThemeExtension<AdminColors> {
  ...
  static const AdminColors light = AdminColors(
    bgBase: lBgBase,
    bgSurface: lBgSurface,
    bgSurface2: lBgSurface2,
    bgSurface3: lBgSurface3,
    border: lBorder,
    border2: lBorder2,
    border3: lBorder3,
    ...
    textDisabled: lTextDisabled,
    accent: lAccent,
    accentBright: lAccentBright,
    accentFill: lAccentFill,
    accentFill2: lAccentFill2,
    btnPrimary: lBtnPrimary,
    btnPrimaryFg: lBtnPrimaryFg,
    btnSecondary: lBtnSecondary,
    btnSecondaryFg: lBtnSecondaryFg,
    success: lSuccess,
    successFill: lSuccessFill,
    successText: lSuccessText,
    warning: lWarning,
    warningFill: lWarningFill,
    warningText: lWarningText,
    error: lError,
    errorFill: lErrorFill,
    errorText: lErrorText,
    isDark: false,
  );

  static const AdminColors dark = AdminColors(
    bgBase: dBgBase,
    bgSurface: dBgSurface,
    bgSurface2: dBgSurface2,
    bgSurface3: dBgSurface3,
    border: dBorder,
    border2: dBorder2,
    border3: dBorder3,
    ...
    accent: dAccent,
    accentBright: dAccentBright,
    accentFill: dAccentFill,
    accentFill2: dAccentFill2,
    btnPrimary: dBtnPrimary,
    btnPrimaryFg: dBtnPrimaryFg,
    btnSecondary: dBtnSecondary,
    btnSecondaryFg: dBtnSecondaryFg,
    success: dSuccess,
    successFill: dSuccessFill,
    successText: dSuccessText,
    warning: dWarning,
    warningFill: dWarningFill,
    warningText: dWarningText,
    error: dError,
    errorFill: dErrorFill,
    errorText: dErrorText,
    isDark: true,
  );
  ...
  AdminColors copyWith({
    ...
    return AdminColors(
      ...
      accentFill2: accentFill2 ?? this.accentFill2,
      btnPrimary: btnPrimary ?? this.btnPrimary,
      btnPrimaryFg: btnPrimaryFg ?? this.btnPrimaryFg,
...
ThemeData adminThemeDark() {
  ...
  return base.copyWith(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(radiusInput),
        borderSide: const BorderSide(color: dAccent, width: 2.5),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(radiusInput),
